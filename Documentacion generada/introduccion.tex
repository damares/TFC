...
%      internet.
    ...
    \subsection{Procesos automatizados}
    	...
    	Algunas herramientas automáticas proporcionan un interfaz de programación para el diseño e implementación de ontologías, exploradores de ontologías, conversores, razonadores, motores de búsqueda, etiquetadores, validadores, visores... Exiten diversas páginas como \textit{http://www.w3.org/2001/sw/wiki/Tools}, \textit{http://semanticweb.org/wiki/Tools}, \textit{http://www.mkbergman.com/sweet-tools-simple-list/} o \textit{http://protegewiki.stanford.edu/wiki/Protege\_Plugin\_Library} donde hay repositorios y se pueden encontrar las herramientas agrupadas por categorías, lenguajes de programación... A modo enunciativo, y para que el lector pueda tener una primera impresión de las capacidades del lenguaje, se enumeran algunas de las herramientas.
