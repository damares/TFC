...
\lstloadlanguages{owlms,protege,ace,[]Java}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cabeceras para la importación de las hojas de cálculo

	\usepackage{pdfpages}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Items que se salen de la justificacion
	\usepackage{enumitem}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% pies de imagenes muy largos
	\usepackage{caption}
