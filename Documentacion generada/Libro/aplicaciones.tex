...
\subsection{HermiT}
Se trata de un razonador para ontologías OWL. HermiT\footnote{http://www.hermit-reasoner.com/} es capaz de determinar si una ontología es o no consistente, identifica relaciones del tipo "es un" y más. Hace uso de un nuevo algoritmo que lo hace más eficaz que cualquier otro utilizado anteriormente, y cumple con los estándares OWL2. La versión utilizada es la 1.3.6. Es un razonador de código abierto bajo licencia LGPL.

\subsection{RacerPro}
RacerPro\footnote{http://www.racer-systems.com/products/racerpro/} es el nombre comercial de un razonador para OWL. Existe un plugin para Protégé llamado RacerProTG\footnote{http://protegewiki.stanford.edu/wiki/RacerProTG} que trabaja de forma automática con la última versión disponible del razonador RacerPro (existe una licencia gratuita y permanente para el uso del plugin junto con Protégé). 

\subsection{Pellet}
Pellet\footnote{http://clarkparsia.com/pellet} es un razonador para ontologías OWL, que añade la particularidad de permitir razonamiento incremental, de modo que no es preciso realizar un recálculo de las inconsistencias ni de la clasificación cuando tiene lugar algún cambio en el TBox o en el ABox.
...
%		\includegraphics[width=1.00\textwidth]{Imagenes/Herramientas-changeview.png}
%\end{center}
%\captionof{figure}[Herramienta - ChangeView]{Herramienta - ChangeView}
