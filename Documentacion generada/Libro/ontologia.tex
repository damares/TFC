...
\subsection{Clases de la ontología}
	...
	Las clases se pueden definir en protégé como conjuntos que contienen individuos. Las clases se describen utilizando descripciones formales que definen inequívocamente los requisitos de pertenencia a una clase. 
  ...
  %\lstinputlisting[language=owlms,literate=,firstnumber=671,firstline=671,lastline=672]{t-box.ms}
	...
	\begin{description}
		...
		\lstinputlisting[caption={Descripción de la clase \lstinline!Objetivo General!},label=Objetivo,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Objetivo_General-max\ 1\ xsd:string]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la clase \lstinline!Competencia!},label=Competencia,captionpos=b,language=owlms,literate=,firstnumber=595,firstline=595,lastline=608]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la clase \lstinline!Competencia_General!},label=cg,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Competencia_General-Competencia_Especifica]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la clase \lstinline!Competencia_Especifica!},label=ce,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Competencia_Especifica-Competencia_General]{t-box.ms}	
		...
		\item[Materia.]La clase \lstinline!Materia! aglutina todos los individuos que representan las diferentes materias de que se compone la titulación. Coloquialmente podemos entender las materias como aquellos individuos que permiten al alumno adquirir competencias, de modo que puedan cumplir con las objetivos generales del título. Formalmente hablando, son materias todos aquellos individuos relacionados con algún individuo de la clase Competencia, y al menos una vez con alguna \lstinline!Competencia_General!. Posteriormente se definirá la propiedad que une \lstinline!Materia! con \lstinline!Compentencia! y con \lstinline!Competencia_General!. 
   		...
   		\lstinputlisting[caption={Descripción de la clase \lstinline!Materia!},label=Materia,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Materia-only\ ects:Metodo_Docente]{t-box.ms}	
	...
	Las asignaturas optativas quedan, por el momento, fuera del alcance de este trabajo, por no estar definidas en el documento remitido a ANECA. No obstante, tal y como se verá más adelante, es posible crear incorporar al plan de estudios cualquier asignatura optativa, con todas las características de cualquier asignatura, de modo que la materia ``Optatividad'' esté completa. }
      	...
      	\lstinputlisting[caption={Descripción de la clase \lstinline!Asignatura!},label=Asignatura,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Asignatura-only\ ects:Caracter]{t-box.ms}		
...
%		\lstinputlisting[language=owlms,literate=,firstnumber=720,firstline=720,lastline=731]{t-box.ms}	
      	...
      	\lstinputlisting[caption={Descripción de la clase \lstinline!Actividad_Formativa!},label=Actividad,captionpos=b,language=owlms,literate=,firstnumber=720,firstline=720,lastline=731]{t-box.ms}	
	...
	\lstinputlisting[caption={Descripción de la clase \lstinline!Metodo_Docente!},label=docente,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Metodo_Docente-max\ 1\ xsd:string]{t-box.ms}
	...
	\lstinputlisting[caption={Descripción de la clase \lstinline!Metodo_Evaluacion!},label=evaluacion,captionpos=b,language=owlms,literate=,linerange=Class:\ ects:Metodo_Evaluacion-max\ 1\ xsd:string]{t-box.ms}
	...
	\lstinputlisting[caption={Descripción de la clase \lstinline!Ubicacion_Temporal!},label=ubicacion,captionpos=b,language=owlms,literate=,firstnumber=674,firstline=674,lastline=688]{t-box.ms}    	
	...
	\lstinputlisting[caption={Descripción de la clase \lstinline!Caracter!},label=caracter,captionpos=b,language=owlms,literate=,firstnumber=626,firstline=626,lastline=640]{t-box.ms}       	
	...
	\begin{description}
		...
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!OG_seCumpleMedianteLaAdquisicionDe_CO!},label=og-co,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:OG_seCumpleMedianteLaAdquisicionDe_CO-ects:CO_seAdquiereParaCumplir_OG]{t-box.ms}	
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!CO_seAdquiereParaCumplir_OG!},label=co-og,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CO_seAdquiereParaCumplir_OG-ects:OG_seCumpleMedianteLaAdquisicionDe_CO]{t-box.ms}	
    	...
    	\lstinputlisting[caption={Descripción de la propiedad \lstinline!CO_esOtorgadaPor_MA!},label=co-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CO_esOtorgadaPor_MA-ects:MA_otorgaCompetencias_CO]{t-box.ms}	
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_otorgaCompetencias_CO!},label=ma-co,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_otorgaCompetencias_CO-ects:CO_esOtorgadaPor_MA]{t-box.ms}	
	    ...
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!CG_esOtorgadaPor_MA!},label=cg-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CG_esOtorgadaPor_MA-ects:MA_otorgaCompetenciasGenerales_CG]{t-box.ms}	
	    	\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_otorgaCompetenciasGenerales_CG!},label=ma-cg,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_otorgaCompetenciasGenerales_CG-ects:CG_esOtorgadaPor_MA]{t-box.ms}	
	   	...
	   	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    		...
    		\lstinputlisting[caption={Descripción de la propiedad \lstinline!CE_esOtorgadaPor_MA!},label=ce-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CE_esOtorgadaPor_MA-ects:MA_otorgaCompetenciasEspecificas_CE]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_otorgaCompetenciasEspecificas_CE!},label=ma-ce,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_otorgaCompetenciasEspecificas_CE-ects:CE_esOtorgadaPor_MA]{t-box.ms}
        ...
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_constaDe_AS!},label=ma-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_constaDe_AS-ects:AS_formaParteDe_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!AS_formaParteDe_MA!},label=as-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AS_formaParteDe_MA-ects:MA_constaDe_AS]{t-box.ms}
        ...
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_seImparteMediante_ME!},label=ma-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_seImparteMediante_ME-ects:ME_utilizadoParaImpartir_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!ME_utilizadoParaImpartir_MA!},label=me-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:ME_utilizadoParaImpartir_MA-ects:MA_seImparteMediante_ME]{t-box.ms}
        ...
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_seImparteSegun_AF!},label=ma-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_seImparteSegun_AF-ects:AF_utilizadaParaImpartir_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!AF_utilizadaParaImpartir_MA!},label=af-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AF_utilizadaParaImpartir_MA-ects:MA_seImparteSegun_AF]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_tiene_CA!},label=ma-ca,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_tiene_CA-ects:CA_agrupa_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!CA_agrupa_MA!},label=ca-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CA_agrupa_MA-ects:MA_tiene_CA]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_ubicada_UT!},label=ma-ut,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_ubicada_UT-ects:UT_contiene_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!UT_contiene_MA!},label=ut-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:UT_contiene_MA-ects:MA_ubicada_UT]{t-box.ms}
		...
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_utiliza_MV!},label=ma-mv,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MA_utiliza_MV-ects:MV_esUtilizadoEn_MA]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!MV_esUtilizadoEn_MA!},label=mv-ma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:MV_esUtilizadoEn_MA-ects:MA_utiliza_MV]{t-box.ms}
	    ...
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!AS_esRequisitoPara_AS!},label=as-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AS_esRequisitoPara_AS-ects:AS_tieneComoRequisito_AS]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!AS_tieneComoRequisito_AS!},label=as-as2,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AS_tieneComoRequisito_AS-ects:AS_esRequisitoPara_AS]{t-box.ms}
	    ...
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!AS_tiene_CA!},label=as-ca,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AS_tiene_CA-ects:CA_agrupa_AS]{t-box.ms}
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!CA_agrupa_AS!},label=ca-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CA_agrupa_AS-ects:AS_tiene_CA]{t-box.ms}
	    ...
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!AS_ubicada_UT!},label=as-ut,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:AS_ubicada_UT-ects:UT_contiene_AS]{t-box.ms}
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!UT_contiene_AS!},label=ut-as,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:UT_contiene_AS-ects:AS_ubicada_UT]{t-box.ms}
	    ...
	    \lstinputlisting[caption={Descripción de la propiedad \lstinline!CA_agrupa_ASMA!},label=ca-asma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:CA_agrupa_ASMA-or\ ects:Materia]{t-box.ms}
        \lstinputlisting[caption={Descripción de la propiedad \lstinline!UT_contiene_ASMA!},label=ut-asma,captionpos=b,language=owlms,literate=,linerange=ObjectProperty:\ ects:UT_contiene_ASMA-or\ ects:Materia]{t-box.ms}
	...
	\begin{description}
		...
		\item [OG\_Descripcion.] Se trata de una relación entre un individuo de la clase \lstinline!Objetivo\_General! y un dato de tipo literal. Esta relación funcional (un objetivo sólo puede tener una descripción) es útil para guardar la descripción del objetivo descrito, y poder identificarlo por algo menos formal y más útil que la numeración del objetivo.
   		\lstinputlisting[caption={Descripción de la propiedad \lstinline!OG_Descripcion!},label=og,captionpos=b,language=owlms,literate=,linerange=DataProperty:\ ects:OG_Descripcion-xsd:string]{t-box.ms}
	   ...
	   \item [CO\_Descripcion.] Esta propiedad relaciona una competencia con un literal. También es una propiedad funcional, y al igual que el resto de propiedades dedicadas a almacenar información acerca de descripciones de individuos, es útil para poder identificar los mismos por algo más que el código descriptivo.
   		\lstinputlisting[caption={Descripción de la propiedad \lstinline!CO_Descripcion!},label=co,captionpos=b,language=owlms,literate=,linerange=DataProperty:\ ects:CO_Descripcion-xsd:string]{t-box.ms}
	    ...
	    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   		...
   		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_Creditos!},language=owlms,captionpos=b,label=ma,literate=,linerange=DataProperty:\ ects:MA_Creditos-tipoCredito]{t-box.ms} 
	   ...
	   \item [MA\_Coordinacion.] Esta ``type property'' se utiliza como un campo libre donde se define de manera informal los agentes que coordinarán la materia, y cuando se defina, las herramentas que utilizarán en su cometido.
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MA_Coordinacion!},label=ma,language=owlms,captionpos=b,language=owlms,literate=,linerange=DataProperty:\ ects:MA_Coordinacion-xsd:string]{t-box.ms} 
		...
		\item [ME\_Descripcion.] Se trata de una relación entre un individuo de la clase \lstinline!Método\_Docente! y un dato de tipo literal. Esta relación funcional (un método docente sólo puede tener una descripción) es útil para guardar la descripción del método descrito.
   		\lstinputlisting[caption={Descripción de la propiedad \lstinline!ME_Descripcion!},captionpos=b,label=de,language=owlms,literate=,linerange=DataProperty:\ ects:ME_Descripcion-xsd:string]{t-box.ms}   
		...
		\lstinputlisting[caption={Descripción de la propiedad \lstinline!AF_Creditos!},captionpos=b,label=af,language=owlms,literate=,linerange=DataProperty:\ ects:AF_Creditos-ects:tipoCredito]{t-box.ms}   
		...
		\item [MV\_Descripcion.] Recoge una pequeña descripción informal del método de evaluación con el que está relacionado, de modo que sea fácil comprobar las pruebas y técnicas de evaluación que el docente utilizará a la hora de verificar el nivel de adquisición de competencias por parte de los alumnos.
   		\lstinputlisting[caption={Descripción de la propiedad \lstinline!MV_Descripcion!},captionpos=b,label=mv,language=owlms,literate=,linerange=DataProperty:\ ects:MV_Descripcion-xsd:string]{t-box.ms} 
	\end{description}
...
El resto de tipos de datos utilizados, son los primitivos del lenguaje xml, y vienen descritos en las pagínas \textsl{http://www.w3.org/TR/xmlschema11-2/} y \textsl{http://www.w3.org/TR/rdf-schema/}
	...
	\lstinputlisting[caption={Descripción de los tipos de datos},captionpos=b,label=tad,language=owlms,literate=,linerange=Datatype:\ xsd:decimal-Datatype:\ rdfs:Literal]{t-box.ms} 
