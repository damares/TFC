...
\section{ABox: Grado en Informática por la UPM}
...
%\subsection{Individuos de la ontología}
	...
	%\todo{dejar sólo una de ellas}
		...
		\begin{description}
			...
			\item [Estudio de Casos.] Se trata de analizar de manera intensivaun problema o suceso real con la finalidad de conocerlo y poder generar hipótesis, resolverlo, intrepertarlo\ldots  y con ello adquirir entrenamiento en los procedimientos de tratamiento y resolución.
		...
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ CA\-Básica-ects:Caracter]{a-box.ms} 
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ CA\-Mixta-ects:Caracter]{a-box.ms} 
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ CA\-Obligatoria-ects:Caracter]{a-box.ms} 
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ CA\-Optativa-ects:Caracter]{a-box.ms} 
		...
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ UT\-3er_semestre-ects:Ubicacion_temporal]{a-box.ms} 
		\lstinputlisting[language=owlms,literate=,linerange=Individual:\ UT\-5o_semestre-ects:Ubicacion_temporal]{a-box.ms} 
