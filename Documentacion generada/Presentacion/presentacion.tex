...
\note{Y hasta aqui lo que daba de si el proyecto. Habíamos logrado, trabajando con ontologías, crear un marco único y formal de conocimiento que permitiese especificar de un modo formal el nuevo plan de estudios de modo que fuese más sencilla su comprensión. Se había logrado erradicar el trabajo con herramientas no eficientes como las hojas de cálculo, y se había conseguido con una herramienta que además permitia el trabajo con aplicaciones automáticas. Los itinerarios formativos podían ahora ser especificados de una manera formal, y su adpatación a nuevos criterios normativas mucho más ágil.}
\note{Llegados a este punto la ontología se encontraba lista y terminada, pero ocurría que para cualquier persona que no estiviese familiariazada con las ontologías y sus lenguajes descriptivos, resultaba igualmente de complejo y farragoso el trabajo con hojas de cálculo y ontologías. Y así el punto y final del trabajo se convirtió en el punto incial de una pequeña ampliación. ¿Porqué no aprovechar la web semántica para lograr mayor aplicabilidad a la ontología diseñada?}
