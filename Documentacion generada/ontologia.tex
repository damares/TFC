...
\begin{description}
 ...
 \item [Competencias Específicas]. Estos individuos pertentecientes a la clase \lstinline{Competencia_Especifica}, representan las diferentes competencias específicas que el alumno debe poseer al finalizar el ciclo formativo.
	...
	\lstinputlisting[language=owlms,literate=,linerange=Individual:\ CE\-33-xsd:string]{a-box.ms}
   	...
   	%% Materias
   	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
 \item [Materias]. Estos individuos representan las diferentes materias de la titulación que estamos modelando. De igual modo, sólo se incluyen algunas, a modo de ejemplo ilustrativo.
  ...
  \lstinputlisting[language=owlms,literate=,linerange=Individual:\ ME\-Aprendizaje_orientado_a_proyectos-xsd:string]{a-box.ms} 
  	...
  	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   	...
   	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
  \item [Actividades Formativas]. Como ya se dijo anteriormente, con el fin de poder almacenar la información relativa a los créditos otorgados por cada actividad formativa, se ha optado por crear un individuo por cada relación \lstinline{AF_utilizadaParaImpartir_MA}. A modo de ejemplo:
